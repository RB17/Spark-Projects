...
object LinearRegressionRDD {
  ...
  def main(args: Array[String]) {
    ...
    val trainingLines = sc.textFile("C:\\Users\\rangan_basu\\Documents\\Spark\\workspace\\SparkUdemy\\src\\com\\sparkscalarb\\regression.txt")
    ...
    val testingLines = sc.textFile("C:\\Users\\rangan_basu\\Documents\\Spark\\workspace\\SparkUdemy\\src\\com\\sparkscalarb\\regression.txt")

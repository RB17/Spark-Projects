...
object PopularMoviesDataSets {
  ...
  def loadMovieNames() : Map[Int, String] = {
    ...
    var movieNames:Map[Int, String] = Map()
     ...
     val lines = Source.fromFile("C:\\Users\\rangan_basu\\Documents\\Spark\\workspace\\SparkUdemy\\src\\com\\sparkscalarb\\u.item").getLines()
     for (line <- lines) {
  ...
  def main(args: Array[String]) {
    ...
    val lines = spark.sparkContext.textFile("C:\\Users\\rangan_basu\\Documents\\Spark\\workspace\\SparkUdemy\\src\\com\\sparkscalarb\\u.data").map(x => Movie(x.split("\t")(1).toInt))

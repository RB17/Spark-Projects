...
object MostPopularSuperhero {
  ...
  def main(args: Array[String]) {
    ...
    val names = sc.textFile("C:\\Users\\rangan_basu\\Documents\\Spark\\workspace\\SparkUdemy\\src\\com\\sparkscalarb\\marvel-names.txt")
    val namesRdd = names.flatMap(parseNames)
    
    // Load up the superhero co-apperarance data
    val lines = sc.textFile("C:\\Users\\rangan_basu\\Documents\\Spark\\workspace\\SparkUdemy\\src\\com\\sparkscalarb\\ marvel-graph.txt")
